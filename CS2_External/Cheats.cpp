...
extern double AnglePerPixel;
extern bool rcs_ative;
void Cheats::Menu()
{
	...
	ImGui::Begin("Menu",nullptr,ImGuiWindowFlags_AlwaysAutoResize);
	{
		...
		if (ImGui::BeginTabItem("AimBot "))
		{
			...
			Gui.SliderScalarEx1("AnglePerPixel", ImGuiDataType_Double, &AnglePerPixel, &fuck1, &fuck2, "%.2f", ImGuiSliderFlags_None);
...
void Cheats::Run()
{
	...
	if (MenuConfig::ShowCrossHair)
		//Render::DrawCrossHair(LocalEntity);
